...
const steps: Steps[] = [
  ...
  },
  {
    ...
    text: "AI Analysis",
    description: "Get you PDF analysed by advnace AI processing",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    text: "Get Summary",
    description: "Recieve a clear concise summary of your pdf",
  },
];
const HowItWorks = () => {
  return (
...
function StepItem({ icon, text, description }: Steps) {
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full">
      <div className="flex flex-col gap-4 h-full">
        ...
        <div className="flex flex-col flex-1 gap-1 justify-between">
          <h4 className="text-center font-bold text-xl">{text}</h4>
